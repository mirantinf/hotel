...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->jml_kamar <= $request->stok) {
            ...
            $bookingKamarId = BookingList::where('tipe_kamar_id', $validatedData["tipe_kamar_id"]);
            
            foreach ($bookingKamarId as $bookingId) {
                $booking = BookingList::find($bookingId);
                $booking->barangKamars()->attach($request->barang);
            }
