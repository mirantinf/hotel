        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <div class="navbar-nav dropdown ms-auto">
                ...
                @if (auth()->user()->role === 'USER')
                    <a class="dropdown-item" href="/"><i class="bi bi-layout-text-sidebar-reverse"></i>{{ auth()->user()->role }}</a>
                @elseif (auth()->user()->role === 'RESEPSIONIS')
                    <a class="dropdown-item" href="/resepsionis"><i class="bi bi-layout-text-sidebar-reverse"></i>{{ auth()->user()->role }}</a>
                @elseif (auth()->user()->role === 'ADMIN')
                    <a class="dropdown-item" href="/admin"><i class="bi bi-layout-text-sidebar-reverse"></i>{{ auth()->user()->role }}</a>
                @endif
